...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter=" &quot;LEGEND&quot;  =  'Railway Station' " symbol="0" label="Railway Station"/>
      <rule filter=" &quot;LEGEND&quot;  =  'Rapid Transit Station' " symbol="1" label="Rapid Transit Station"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,115,173,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fontSize" value="320"/>
    ...
    <property key="labeling/xOffset" value="240"/>
