...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="LEGEND" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="Antiquity Line Detail (dyke, wall, etc)" label="Antiquity Line Detail (dyke, wall, etc)"/>
      <category symbol="1" value="Roman Road" label="Roman Road"/>
    </categories>
    <symbols>
