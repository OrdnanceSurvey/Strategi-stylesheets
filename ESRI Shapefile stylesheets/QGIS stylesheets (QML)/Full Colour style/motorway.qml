...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="LEGEND" symbollevels="1" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="Motorway" label="Motorway"/>
      <category symbol="1" value="Motorway over other feature" label="Motorway over other feature"/>
      <category symbol="2" value="Motorway tunnel" label="Motorway tunnel"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="253,243,148,255"/>
          <prop k="customdash" v="5;2"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fontSize" value="410"/>
